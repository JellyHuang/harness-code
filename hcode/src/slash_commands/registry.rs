...
impl CommandRegistry {
    ...
    pub fn with_default_commands() -> Self {
        ...
        registry.register(Arc::new(super::ConfigCommand));
        registry.register(Arc::new(super::CommitCommand));
        registry.register(Arc::new(super::BranchCommand));
        registry.register(Arc::new(super::DiffCommand));
        registry.register(Arc::new(super::DoctorCommand));
        registry.register(Arc::new(super::ExitCommand));
        let help_registry = Arc::new(Self::new());
        registry.register(Arc::new(super::HelpCommand::new(help_registry)));
        registry.register(Arc::new(super::SkillCommand));
